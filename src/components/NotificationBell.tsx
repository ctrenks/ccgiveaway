                ...
                <div key={notification.id}>
                  {notification.link ? (
                    <Link
                      ...
                      className={`block px-4 py-3 hover:bg-slate-800/50 transition border-b border-slate-800/50 ${
                      ...
                      <div className="flex gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2">
                            <span className={`text-sm font-medium ${!notification.isRead ? "text-white" : "text-slate-300"}`}>
                              {notification.title}
                            </span>
                            {!notification.isRead && (
