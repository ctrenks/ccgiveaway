      ...
      <div className="max-w-2xl">
            ...
            <div className="mt-6 pt-6 border-t border-slate-800 space-y-4">
              ...
              <label className="flex items-center gap-3 p-3 bg-slate-800/50 rounded-lg cursor-pointer hover:bg-slate-800 transition-colors">
                <input
                  ...
                  className="w-5 h-5 text-purple-500 bg-slate-700 border-slate-600 rounded focus:ring-purple-500"
                />
                <div>
                  <div className="text-white font-medium">Foil Version</div>
                  <div className="text-slate-400 text-sm">Check if this is a foil card (uses foil price if available)</div>
                </div>
              </label>
            </div>
        ...
        <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-6">
          ...
          <ol className="list-decimal list-inside space-y-2 text-slate-400 text-sm">
            ...
            <li>Check "Foil Version" if applicable (will use foil price)</li>
