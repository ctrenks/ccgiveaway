        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-slate-400 mt-2">
              Discuss cards, giveaways, trades, and more with the community
            </p>
          </div>
          {session?.user && (
            <Link
              href="/forum/messages"
              className="bg-purple-600/20 border border-purple-500/30 text-purple-400 px-4 py-2 rounded-lg hover:bg-purple-600/30 transition flex items-center gap-2"
            >
              💬 Messages
            </Link>
          )}
        ...
        <div className="space-y-4">
          {categories.length === 0 ? (
            <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-12 text-center">
              ...
              <p className="text-slate-400">Check back soon for community discussions!</p>
            ...
            categories.map((category) => (
              <Link
                ...
                className="block bg-slate-900/50 border border-slate-800 rounded-2xl hover:border-purple-500/30 transition-all"
              >
                <div className="p-6">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h2 className="text-xl font-bold text-white hover:text-purple-400 transition">
                            {category.name}
                          </h2>
                      ...
                      {category.topics?.[0] && (
                        <div className="mt-2 text-sm text-slate-400">
                          ...
                          <div className="text-xs text-slate-500 mt-1">
                            by {category.topics[0].author?.displayName || category.topics[0].author?.name || "Unknown"} •{" "}
